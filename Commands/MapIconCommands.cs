...
// Commands for managing map icons.
[CommandGroup("mapicon", "mi")]
class MapIconCommands
{
    [Command("create", "c", description: "Creates a map icon at the player's location.", adminOnly: true)]
    ...
    [Command("destroy", "d", description: "Destroys a map icon you're standing on", adminOnly: true)]
    ...
    [Command("list", "l", description: "Lists all map icon prefabs with text", adminOnly: true)]
